...
export default function ElevatorScene({ boyRef, progress, activeIdx, isGreenGlow }: ElevatorSceneProps) {
  // Determine current floor text based on milestones
  const getLevelLabel = (prog: number) => {
    if (prog >= 0.85) return 'LEVEL 04 — CAREER';
    if (prog >= 0.60) return 'LEVEL 03 — PROJECTS';
    ...
    <div className="w-full md:w-1/2 flex flex-col items-center justify-center md:sticky md:top-[85px] py-8 z-20 self-start">
      ...
      >
        ...
        >
          ...
          <span style={{ color: '#7c3aed', paddingLeft: '12px' }}>void</span>{' '}
        ...
        >
          ...
          <span style={{ color: '#7c3aed', paddingLeft: '12px' }}>return</span>{' '}
        ...
        <div className="w-full flex flex-col items-center px-4 relative z-20">
          ...
          <div
            ...
            style={{
              backgroundColor: isGreenGlow ? '#00ff88' : 'rgba(0, 255, 136, 0.25)',
        ...
        <div className="absolute inset-0 w-full h-[520px] pointer-events-none z-10">
          <svg viewBox="0 0 340 520" className="w-full h-full absolute inset-0">
            <defs>
              ...
              <linearGradient id="stepRiserGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#1e1e2f" />
                <stop offset="100%" stopColor="#0a0a12" />
              </linearGradient>
              <linearGradient id="stepTreadGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#00ff88" />
                <stop offset="50%" stopColor="#0ea5e9" />
                <stop offset="100%" stopColor="#7c3aed" />
              </linearGradient>
              <linearGradient id="portalCenterGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <g className="spinning-gear" transform="translate(50, 460)">
              <circle cx="0" cy="0" r="16" fill="#131324" stroke="#7c3aed" strokeWidth="2" />
              <circle cx="0" cy="0" r="10" fill="#09090f" stroke="#00ff88" strokeWidth="1" />
              <line x1="-16" y1="0" x2="14" y2="0" stroke="#7c3aed" strokeWidth="3" />
              <line x1="0" y1="-16" x2="0" y2="16" stroke="#7c3aed" strokeWidth="3" />
              <line x1="-11" y1="-11" x2="11" y2="11" stroke="#7c3aed" strokeWidth="2" />
              <line x1="-11" y1="11" x2="11" y2="-11" stroke="#7c3aed" strokeWidth="2" />
            </g>
            ...
            <g id="top-door-portal">
              ...
              <rect x="256" y="68" width="52" height="84" rx="8" fill="#09090f" stroke="#7c3aed" strokeWidth="3" />

              {/* Inner glowing portal grid visible when doors slides away */}
              <rect x="260" y="72" width="44" height="76" rx="5" fill="#050508" />
              <rect
                x="260"
                y="72"
                width="44"
            ...
            <text
              ...
              style={{
                letterSpacing: '1px',
                filter: isGreenGlow ? "drop-shadow(0 0 6px rgba(0, 255, 136, 0.7))" : "none",
              ...
              {Array.from({ length: 11 }).map((_, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <line x1="-9" y1="2" x2="-9" y2="12" stroke="#1f2937" strokeWidth="0.75" />
                    <line x1="-5" y1="2" x2="-5" y2="12" stroke="#1f2937" strokeWidth="0.75" />
                    <line x1="-1" y1="2" x2="-1" y2="12" stroke="#1f2937" strokeWidth="0.75" />
                    <line x1="3" y1="2" x2="3" y2="12" stroke="#1f2937" strokeWidth="0.75" />
                    <line x1="7" y1="2" x2="7" y2="12" stroke="#1f2937" strokeWidth="0.75" />
            ...
            {/* Platforms */}
            <line x1="15" y1="460" x2="65" y2="460" stroke="#7c3aed" strokeWidth="4" strokeLinecap="round" />
            <line x1="255" y1="150" x2="315" y2="150" stroke="#7c3aed" strokeWidth="4" strokeLinecap="round" />
          </svg>
          ...
          >
            <div className="boy-breathe-anim w-full h-full">
              ...
              <svg width="44" height="80" viewBox="0 0 44 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className="boy-hair-flutter" d="M 12 16 C 11 12, 14 8, 22 7 C 30 8, 33 12, 32 16 Z" fill="#1e1a14" />

                {/* Tech backpack (behind body) */}
                <path className="boy-backpack-straps" d="M 8 34 L 12 28 L 32 28 L 36 34 L 36 52 L 8 52 Z" fill="#2e1065" stroke="#7c3aed" strokeWidth="1.5" />
                <rect x="14" y="34" width="16" height="14" fill="#4c1d95" opacity="0.65" rx="2" />

                {/* Left Arm (Swing animated) */}
                <g className="boy-left-arm">
                  <path d="M 10 32 L 2 46 C 1 48, 1 50, 2 52 C 4 54, 7 53, 9 49 L 14 36 Z" fill="#5b21b6" stroke="#c084fc" strokeWidth="0.5" />
                  <circle cx="3" cy="51" r="2.5" fill="#f9c98e" />
                </g>

                {/* Left Leg (Walk animated) */}
                <g className="boy-left-leg">
                  <rect x="11" y="55" width="6" height="15" rx="1.5" fill="#1e1b4b" stroke="rgba(255,255,255,0.1)" strokeWidth="0.5" />
                  {/* Sneaker with Glowing Sole */}
                  <path d="M 11 69 L 18 69 L 20 75 L 8 75 Z" fill="#111827" />
                  <path d="M 8 73 L 20 73 L 20 75 L 8 75 Z" fill="#00ff88" style={{ filter: 'drop-shadow(0 0 3px #00ff88)' }} />
                </g>

                {/* Right Leg (Walk animated) */}
                <g className="boy-right-leg">
                  <rect x="27" y="55" width="6" height="15" rx="1.5" fill="#1e1b4b" stroke="rgba(255,255,255,0.1)" strokeWidth="0.5" />
                  {/* Sneaker with Glowing Sole */}
                  <path d="M 27 69 L 34 69 L 36 75 L 24 75 Z" fill="#111827" />
                  <path d="M 24 73 L 36 73 L 36 75 L 24 75 Z" fill="#00ff88" style={{ filter: 'drop-shadow(0 0 3px #00ff88)' }} />
                </g>

                {/* Body Torso (High Tech Hoodie with details) */}
                <path d="M 10 31 L 34 31 C 36 31, 36 33, 36 34 L 33 56 C 33 58, 11 58, 11 58 L 8 34 C 8 33, 8 31, 10 31 Z" fill="#4c1d95" stroke="#7c3aed" strokeWidth="1" />

                {/* Neon zip line */}
                <line x1="22" y1="31" x2="22" y2="56" stroke="#00ff88" strokeWidth="1.5" />

                {/* Tech logo badge */}
                <rect x="13" y="35" width="5" height="4" rx="1" fill="#111827" />
                <circle cx="15.5" cy="37" r="1" fill="#00ff88" />

                {/* Right Arm (Swing animated) */}
                <g className="boy-right-arm">
                  <path d="M 34 32 L 42 46 C 43 48, 43 50, 42 52 C 40 54, 37 53, 35 49 L 30 36 Z" fill="#5b21b6" stroke="#c084fc" strokeWidth="0.5" />
                ...
                <g className="boy-head">
                  ...
                  <path d="M 14 15 L 30 15 C 31 15, 31 18, 30 19 L 14 19 C 13 19, 13 15, 14 15 Z" fill="#00ff88" style={{ filter: 'drop-shadow(0 0 4px #00ff88)' }} />
                  <line x1="16" y1="17" x2="28" y2="17" stroke="#fff" strokeWidth="1" opacity="0.8" />

                  {/* Smiling mouth strip */}
                  <path d="M 19 22 Q 22 24 25 22" stroke="#111827" strokeWidth="1" fill="none" strokeLinecap="round" />

                  {/* Front Hair bangs (Flutter animated) */}
                  <path className="boy-hair-flutter" d="M 12 15 C 15 11, 29 11, 32 15 C 30 13, 26 10, 22 11 L 18 10 C 15 11, 13 13, 12 15 Z" fill="#111827" />

                  {/* Glowing gaming headset band */}
                  <path d="M 12 18 A 10 10 0 0 1 32 18" fill="none" stroke="#7c3aed" strokeWidth="2.5" />
                  <circle cx="12" cy="18" r="2" fill="#00ff88" style={{ filter: 'drop-shadow(0 0 3px #00ff88)' }} />
                  <circle cx="32" cy="18" r="2" fill="#00ff88" style={{ filter: 'drop-shadow(0 0 3px #00ff88)' }} />
                </g>
              </svg>
            </div>
          </div>
        ...
        <div className="w-full flex flex-col items-center px-4 relative z-20">
          ...
          <div className="w-[180px] h-0.5 mt-4 relative">
            <div className="elevator-ground-line" style={{ left: '0', width: '100%', position: 'absolute' }} />
          </div>
