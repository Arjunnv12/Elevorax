...
export default function Reviews() {
  const testimonials = [
    {
      ...
      quote: '"I came in knowing nothing about Java beyond basics. The Spring Boot classes and mock interviews prepared me thoroughly. In 6 months, I went from a curious hobbyist to a production engineer!"',
    ...
    },
    {
      ...
      quote: '"The Python + ML track opened doors I didn\'t think were accessible without a PhD. Coding FastAPI endpoints and building direct models gave me deep confidence. Excellent mentors!"',
    ...
    },
    {
      ...
      quote: '"The dual bundle was a game changer for me. Understanding both the robustness of enterprise core Java systems and the lightweight rapid prototyping of Python gave me a massive tech advantage."',
  ...
  return (
    <section id="reviews" className="relative py-24 bg-[#f5f5f7] overflow-hidden">
      {/* Glow blob far right */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-sm sm:text-base font-light">
            See how our alumni successfully transitioned from code novices to professional engineers.
          </p>
        </div>
          ...
          {testimonials.map((t, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 pt-5 border-t border-slate-200/50">
                <div className={`w-11 h-11 rounded-full ${t.avatarBg} flex items-center justify-center font-bold text-sm shrink-0`}>
                  {t.avatarInitials}
                </div>
                <div>
